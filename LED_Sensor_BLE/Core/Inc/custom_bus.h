...
#define BUS_SPI1_SCK_GPIO_CLK_DISABLE() __HAL_RCC_GPIOE_CLK_DISABLE()
#define BUS_SPI1_SCK_GPIO_PORT GPIOE
#define BUS_SPI1_SCK_GPIO_PIN GPIO_PIN_13
#define BUS_SPI1_SCK_GPIO_AF GPIO_AF5_SPI1
#define BUS_SPI1_SCK_GPIO_CLK_ENABLE() __HAL_RCC_GPIOE_CLK_ENABLE()
